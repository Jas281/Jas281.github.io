/*
Name: Jaskaran Chaudhary
Student ID: - 116279209
Email: jchaudhary11@myseneca.ca
Date: - 18-04-2021 
*/
...
function toggleLoading(isLoading) {
  ...
  var magIcon = document.getElementById("search-icon");
  var hourIcon = document.getElementById("load-icon");
  var button = document.getElementById("search-button");
  if (isLoading) {
    console.log("Is loading...");
    magIcon.style.display = "none";
    hourIcon.style.display = "inline";
    button.lastElementChild.innerHTML = "Loading...";
    button.disabled = true;
  } else {
    console.log("Loading done!");
    magIcon.style.display = "inline";
    hourIcon.style.display = "none";
